...
class Agent:
    ...
    def bfs(self,avoid_backing_out,updateInfoScreen):  
        inital_node =  Node(self.init_matrix.copy(),self.pos_agent,self.pos_target,0,None,None)
        nodes_expanded= 0
        nodes_created= 0    
        ...
        while not queue.empty():          
            ...
            if(current_node.posAgente in positions_explored and avoid_backing_out):#si esta activado el evitar devolvsere verifico si el nodo ya ha sido expandido de esta manera evito expandir los mismo nodos
                    continue 
    ...
    def aStar(self,avoid_backing_out,updateInfoScreen):          
        ...
        while len(queue)>0:          
            ...
            for child in childs:          
                ...
                for i,node in  enumerate(queue):#verifico si ya ha sido creado ese hijo buscandolo en la cola   
